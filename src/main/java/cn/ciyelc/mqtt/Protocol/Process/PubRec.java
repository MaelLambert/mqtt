...
public class PubRec {
    ...
    public void processPubRec(Channel channel, MqttMessageIdVariableHeader variableHeader) {
        ...
        DupPubRelMessageStore dupPubRelMessageStore = new DupPubRelMessageStore().setClientId((String) channel.attr(AttributeKey.valueOf("clientId")).get()).setMessageId(variableHeader.messageId());
